    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            _.initials = {
                ...
                dates: {
                    hy: {
                        days: ["կիրակի", "երկուշաբթի", "երեքշաբթի", "չերեքշաբթի", "հինգշաբթի", "ուրբաթ", "շաբաթ"],
                        daysShort: ["կիր", "երկ", "երք", "չրք", "հնգ", "ուրբ", "շաբ"],
                        daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"],
                        months: ["Հունվար", "Փետրվար", "Մարտ", "Ապրիլ", "Մայիս", "Հունիս", "Հուլիս", "Օգոստոս", "Սեպտեմբեր", "Հոկտեմբեր", "Նոյոմբեր", "Դեկտեմբեր"],
